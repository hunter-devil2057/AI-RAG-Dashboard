...
```bash
git clone https://github.com/yourusername/ai-rag-backend.git
cd ai-rag-backend
```
...
docker-compose up -d
```
*Note: If you don't have Docker, the app will automatically switch to **Local Fallback Mode** (using disk-based Qdrant and in-memory session storage).*
